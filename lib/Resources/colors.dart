...
class Kolor {
  ...
  static const Color primary = Color(0xFF0A3C75);
  static const Color secondary = Color(0xfff8c32c);
  static const Color tertiary = Color(0xFF3F2B00);
...
ColorScheme kColor(BuildContext context) => ColorScheme.fromSeed(
  seedColor: Kolor.primary,
).copyWith(secondary: Kolor.secondary, tertiary: Kolor.tertiary);
